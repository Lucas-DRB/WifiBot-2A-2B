...
public:
	...
	void Avancer(int left_speed, int right_speed);
	void AvancerAccelerer(int left_speed, int right_speed, int acceleration_speed);
	void AvancerDecelerer(int left_speed, int right_speed, int deceleration_speed);
	void Reculer(int left_speed, int right_speed);
	void TournerGauche(int left_speed, int right_speed);
	void TournerDroite(int left_speed, int right_speed);
	void ArreterRobot();

	void ApprocheLogiqueNavigation(int left_speed, int right_speed);

	int FiltrageCapteurIR_Left(int iLeftIR);
	int FiltrageCapteurIR_Right(int iRightIR);
private:
	Mutex mutexRcv;
	Mutex mutexSend;
